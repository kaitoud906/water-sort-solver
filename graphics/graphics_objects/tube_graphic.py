...
class TubeGraphic:
    def __init__(self, tube: Tube, tube_x, tube_y, tube_graphic_width, tube_graphic_height, tube_border_width,
        ...
        self.tube = tube
        self.tube_graphic = pg.Rect(tube_x*0.5, tube_y*0.5, tube_graphic_width*0.5, tube_graphic_height*0.5)
        self.tube_graphic_top_cover = pg.Rect(tube_x*0.5, tube_y*0.5, tube_graphic_width*0.5, tube_border_width*0.5)
        self.visual_indicator_offset = visual_indicator_offset

        self.tube_x = tube_x*0.5
        self.tube_y = tube_y*0.5
        self.tube_graphic_width = tube_graphic_width*0.5
        self.tube_graphic_height = tube_graphic_height*0.5
        self.tube_border_width = tube_border_width*0.5

        self.color_graphics: List[pg.Rect] = self.get_color_graphics(tube_x*0.5, tube_y*0.5,
                                                                     tube_graphic_width*0.5, tube_graphic_height*0.5,
                                                                     tube_border_width*0.5)
